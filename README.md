...
The goal of ecoevodynamo is to …

## Installation

You can install the released version of ecoevodynamo from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("ecoevodynamo")
```
...
#> Warning: package 'torch' was built under R version 4.0.3
## basic example code
```
